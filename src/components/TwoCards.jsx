  ...
  return (
    <div className="flex flex-wrap justify-center items-center">
      <div className="container mx-auto my-1 ">
        <div className="grid grid-cols-2 lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-2  gap-2 max-w-[1400px]">
          {/* First Card */}
          ...
          {/* Second Card */}
          <div className=" md:col-span-1 bg-slate-900 rounded overflow-hidden  shadow-xl m-4 h-[300px] ">
